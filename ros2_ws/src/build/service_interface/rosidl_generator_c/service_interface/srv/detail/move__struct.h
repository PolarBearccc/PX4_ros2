...
enum
{
  service_interface__srv__Move_Event__request__MAX_SIZE = 1
};
// response
enum
{
  service_interface__srv__Move_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Move in the package service_interface.
typedef struct service_interface__srv__Move_Event
{
  service_msgs__msg__ServiceEventInfo info;
  service_interface__srv__Move_Request__Sequence request;
  service_interface__srv__Move_Response__Sequence response;
} service_interface__srv__Move_Event;

// Struct for a sequence of service_interface__srv__Move_Event.
typedef struct service_interface__srv__Move_Event__Sequence
{

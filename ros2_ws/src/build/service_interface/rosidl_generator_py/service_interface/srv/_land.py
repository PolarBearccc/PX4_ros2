...
class Land_Request(metaclass=Metaclass_Land_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.land = kwargs.get('land', bool())
    ...
    def land(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'land' field must be of type 'bool'"
        self._land = value
...
class Land_Event(metaclass=Metaclass_Land_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<service_interface/Land_Request, 1>',
        'response': 'sequence<service_interface/Land_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['service_interface', 'srv'], 'Land_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['service_interface', 'srv'], 'Land_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from service_interface.srv import Land_Request
    ...
    def response(self, value):
        if self._check_fields:
            from service_interface.srv import Land_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Land(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from service_interface.srv import _land
...
class Land(metaclass=Metaclass_Land):
    from service_interface.srv._land import Land_Request as Request
    from service_interface.srv._land import Land_Response as Response
    from service_interface.srv._land import Land_Event as Event

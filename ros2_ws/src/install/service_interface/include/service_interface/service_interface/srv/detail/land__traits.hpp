...
[[deprecated("use service_interface::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const service_interface::srv::Land_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  service_interface::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use service_interface::srv::to_yaml() instead")]]
inline std::string to_yaml(const service_interface::srv::Land_Event & msg)
{
  return service_interface::srv::to_yaml(msg);
}

template<>
inline const char * data_type<service_interface::srv::Land_Event>()
{
  return "service_interface::srv::Land_Event";
}

template<>
inline const char * name<service_interface::srv::Land_Event>()
{
  return "service_interface/srv/Land_Event";
}

template<>
struct has_fixed_size<service_interface::srv::Land_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<service_interface::srv::Land_Event>
  : std::integral_constant<bool, has_bounded_size<service_interface::srv::Land_Request>::value && has_bounded_size<service_interface::srv::Land_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<service_interface::srv::Land_Event>
  : std::true_type {};
